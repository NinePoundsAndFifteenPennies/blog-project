          ...
          <div class="card p-8 mb-8 backdrop-blur-sm bg-white/90 animate-fade-in">
            <div class="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
              ...
              <div class="flex flex-col space-y-2 shrink-0">
                <router-link to="/profile/edit" class="btn-secondary">
                  <svg class="w-5 h-5 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                  </svg>
                  编辑资料
                </router-link>
                <router-link to="/settings/visibility" class="btn-ghost text-sm">
...
export default {
  name: 'Profile',
  components: { Header, Pagination, SearchPreview, FollowStats },
  setup() {
