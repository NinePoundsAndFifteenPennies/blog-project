  ...
  >
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8">
        <div
          class="inline-flex items-center justify-center w-16 h-16 bg-gradient-primary rounded-2xl mb-4 shadow-lg"
        >
          <svg
      ...
      <div class="text-center mt-6">
        <router-link
          to="/"
          class="text-gray-600 hover:text-gray-900 text-sm flex items-center justify-center"
        >
          <svg
            class="w-4 h-4 mr-1"
            fill="none"
