...
public class VisibilitySettingDto {
    ...
    public VisibilitySettingDto() {
    }

    public VisibilitySettingDto(boolean isPublic, boolean visibleToFriends, boolean visibleToFollowing,
